...
@ing9 = Ingredient.create!(name: "Farfalle Pasta", national_price: 2, taxable: false, snap: true)
@ing10 = Ingredient.create!(name: "Marinara Sauce", national_price: 2, taxable: false, snap: true)
@ing11 = Ingredient.create!(name: "Alfredo Sauce", national_price: 2, taxable: false, snap: true)
@ing12 = Ingredient.create!(name: "Canned Mushrooms", national_price: 2, taxable: false, snap: true)
...
@recipe4 = Recipe.create!(name: "Pepperoni Marina Pasta", image: "future_image_of_pepperoni_pasta", total_price:8.00)
RecipeCookware.create!(recipe: @recipe3, cookware: @cookware4)
RecipeCookware.create!(recipe: @recipe3, cookware: @cookware5)
RecipeCookingTip.create!(recipe: @recipe3, tip: @tip2)
